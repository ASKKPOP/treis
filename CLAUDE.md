...
**Core Value:** Plan Contracts: AI proposes options, Builder picks one, scope is sealed with boundaries and success criteria before any execution begins. The only interrupt is a genuine contract violation. This is the thing that makes multi-step AI plans reliable.
